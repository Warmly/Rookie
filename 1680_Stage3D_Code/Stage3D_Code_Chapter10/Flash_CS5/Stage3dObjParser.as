...
// Example:
//
// [Embed (source = "mesh.obj", 
// mimeType = "application/octet-stream")] 
// private var myObjData:Class;
//
// var myMesh:Stage3dObjParser = new Stage3dObjParser(myObjData);
//
// ... set up your transforms, texture, vertex 
// and fragment programs as normal ...
//
// context3D.setVertexBufferAt(0, myMesh.positionsBuffer, 0, 
// 		Context3DVertexBufferFormat.FLOAT_3);
// context3D.setVertexBufferAt(1, myMesh.uvBuffer, 0, 
// 		Context3DVertexBufferFormat.FLOAT_2);
// context3D.drawTriangles(myMesh.indexBuffer, 0,
// 		 myMesh.indexBufferCount);
//
// Notes:
//
// Some older exporters (eg 3dsmax9) format things
// differently (zxy instead of xyz):
// var myMesh:Stage3dObjParser = 
// 		new Stage3dObjParser(myObjData, 1, true);
//
// Also, some exporters flip the U texture coordinate:
// var myMesh:Stage3dObjParser = 
// 		new Stage3dObjParser(myObjData, 1, true, true);]
//
// Hint: no quads allowed!
