package
{
	...
	public class Basic extends Sprite
	{
		...
		private function initBuffer():void
		{
			...
			_vertexBuffer = _context3D.createVertexBuffer(_vertexData.length / 5, 5);
			_vertexBuffer.uploadFromVector(_vertexData, 0, _vertexData.length / 5);
		...
		private function onEnterFrame(e:Event):void
		{
			...
			_mMatrix.identity();
			_mMatrix.appendTranslation(-1, 1, 0);
			_mvpMatrix.identity();
			_mvpMatrix.append(_mMatrix);
			_mvpMatrix.append(_vMatrix);
			_mvpMatrix.append(_pMatrix);
